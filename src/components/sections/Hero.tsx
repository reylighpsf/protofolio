...
export default function Hero() {
  // Ganti dengan URL Google Drive atau GitHub
  const cvUrl = "https://drive.google.com/file/d/1L6ojzfkeVson-Pe8hQqdAjXbJ3Zw2-AM/view?usp=drive_linkASTE_URL_DISINI";

  return (
    <section
      id="home"
      className="min-h-screen flex items-center justify-center relative bg-gradient-to-br from-gray-900 to-gray-800"
    >
      <div className="container mx-auto px-8">
        <div className="grid lg:grid-cols-3 gap-12 items-center">
          ...
          <div className="lg:col-span-1 flex justify-center">
            <div className="w-250p h-250p rounded-2xl overflow-hidden shadow-2xl border-4 border-white/20">
              <img
                src={photoprofile}
